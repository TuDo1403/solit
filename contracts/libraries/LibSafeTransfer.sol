...
library LibSafeTransfer {
    ...
    function safeNativeTransfer(address to, uint256 amount) internal {
        bytes4 nativeTransferFailed = NativeTransferFailed.selector;
        /// @solidity memory-safe-assembly
        assembly {
            // Transfer the ETH and check if it succeeded or not.
            if iszero(call(gas(), to, amount, 0, 0, 0, 0)) {
                // Store the function selector of `NativeTransferFailed()`.
    ...
    function forceSafeNativeTransfer(
        address to,
        uint256 amount,
        uint256 gasStipend
    ) internal {
    ...
    function trySafeNativeTransfer(
        address to,
        uint256 amount,
        uint256 gasStipend
    ...
    function safeERC20TransferFrom(
        ...
        bytes4 transferFromFailed = TransferFromFailed.selector;
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function safeERC20Transfer(
        ...
        bytes4 transferFailed = TransferFailed.selector;
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function safeERC20Approve(
        ...
        bytes4 approveFailed = ApproveFailed.selector;
        /// @solidity memory-safe-assembly
        assembly {
            mstore(0x14, to) // Store the `to` argument.
            mstore(0x34, amount) // Store the `amount` argument.
